  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p>Your Boards does not collect any information from your device.</p>
        <p>Your Boards requests use of the following on your device for the given purposes:</p>
        <ul>
        ...
        <p>
          Details of your boards, items and the pictures, audio and video they use are stored and
